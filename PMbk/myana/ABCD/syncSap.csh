...
cp abcd.cc data/abcd1.cc
cp abcd.cc data/abcd2.cc
...
sed -i 's/mc\/sample_/data/g' data/abcd1.cc
sed -i 's/mc\/sample_/data/g' data/abcd2.cc
...
sed -i 's/abcd()/abcd1()/g' data/abcd1.cc
sed -i 's/Category\[categoryNum\]\.SampleSize/(Category[categoryNum].SampleSize)\/2/g' data/abcd1.cc
sed -i 's/categoryNum/0/g' data/abcd1.cc
sed -i 's/SampleChoise/Data/g' data/abcd1.cc
sed -i 's/\(.*for_MC\)//g' data/abcd1.cc
sed -i 's/\(.*no_bg\)/\/\/\1/g' data/abcd1.cc

sed -i 's/abcd()/abcd2()/g' data/abcd2.cc
sed -i 's/int\ iSample=0/int iSample=(Category[categoryNum].SampleSize)\/2/g' data/abcd2.cc
sed -i 's/categoryNum/0/g' data/abcd2.cc
sed -i 's/SampleChoise/Data/g' data/abcd2.cc
sed -i 's/\(.*for_MC\)//g' data/abcd2.cc
sed -i 's/\(.*no_bg\)/\/\/\1/g' data/abcd2.cc
