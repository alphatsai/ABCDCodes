...
//void ana2() 
{
	...
	string sample = "TT_Mtt-1000toInf_CT10_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1";
	...
	TFile* newfile = new TFile( "TT1000_Mtt.root","recreate");
