...
void skimPlots(){
	setTDRStyle();
	string Load_bg = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/1218/result/root/mc/bg";
	string Load_data = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/1218/result/root/data";
