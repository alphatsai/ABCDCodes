...
void mkplot()
{
    ...
    for(int idx=0; idx<NPOINTS; idx++) {
        ...
        get_limits(TString::Format("/home/hep/alpha78718/mywk/ntupleBprimeKit_Ana/CMSSW_5_3_2_patch5/src/mass/1209/resurlt/LimitLog/root/higgsCombineTest.Asymptotic.mH%d.root",idx*100+500),limits[idx]);
   ...
   // TH2F *frame = new TH2F("frame","frame",10,400,1100,10,0.5,max*2);
	...
	c1->SaveAs("/home/hep/alpha78718/mywk/ntupleBprimeKit_Ana/CMSSW_5_3_2_patch5/src/mass/1209/resurlt/png/limit/limit.png");	
