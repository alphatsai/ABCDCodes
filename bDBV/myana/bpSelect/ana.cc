...
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/interface/TriggerBooking.h"
...
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/interface/reRegestJet.C"
...
void ana()
{
	...
	for( int iSample=0; iSample<Category[categoryNum].SampleSize; iSample++){   //FullPart
		...
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/root/mc/sample_/"+SampleChoise[iSample].name+".root";
