...
using namespace std;
void checkABCD2D(){
	string load="/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/root/abcd";
	string path="/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/png/abcd";
	vector<string> f;
