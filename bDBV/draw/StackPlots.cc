...
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/interface/setTDRStyle.C"
using namespace std;
...
//	TFile* bosf[BosMC_TotalNum];	
	...
	string SavePngPath = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/png/stack";
	string SavePngPaths = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/png/mc/sig";
	string SavePngPathbq = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/png/mc/bg";
	string SigRootPath = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/root/mc/sig";
	string BgRootPath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDBV/result/root/mc/bg";
