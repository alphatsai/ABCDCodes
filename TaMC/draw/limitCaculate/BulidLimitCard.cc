...
void BulidLimitCard(){
	...
	string QCDRootPath = "/home/hep/alpha78718/mywk/ntupleBprimeKit_Ana/CMSSW_5_3_2_patch5/src/mass/TaMC/resurlt/root/mc/bg";
	string TTRootPath  = "/home/hep/alpha78718/mywk/ntupleBprimeKit_Ana/CMSSW_5_3_2_patch5/src/mass/TaMC/resurlt/root/mc/bg";
	string BosRootPath = "/home/hep/alpha78718/mywk/ntupleBprimeKit_Ana/CMSSW_5_3_2_patch5/src/mass/TaMC/resurlt/root/mc/bg";
...
//	cout<<"//////////////////////////////////////////////////////////////////"<<endl;
	for(int i=0; i<SigMC_TotalNum; i++){
		...
		string cardSave = "/home/hep/alpha78718/mywk/ntupleBprimeKit_Ana/CMSSW_5_3_2_patch5/src/mass/TaMC/resurlt/txt/limitCard/limitCard_" + SigMC[i].name + ".txt";		
