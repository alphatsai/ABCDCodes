#!/bin/tcsh
source sync.csh
set logPath="/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/0105/result/log"
cmsenv
...
cd /afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/0105/result/root/abcd
	foreach sig($sigs)
