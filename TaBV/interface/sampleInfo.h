...
const double lumi = 19.707; // fb-1, sqrt(s)=8TeV
const int TotalNum = 4;  //1
const int Data_TotalNum = 7;  //1
...
struct Data_ Data[Data_TotalNum] = {
	{"Jet_Run2012A", 	"Jet-2012A", 	 	1, 1},	
	{"Jet_Run2012A_mis", 	"Jet-2012A_mis", 	1, 1},	
	{"JetHT_Run2012B", 	"JetHT-2012B", 		1, 1},	
	{"JetHT_Run2012B_mis", 	"JetHT-2012B_mis", 	1, 1},	
	{"JetHT_Run2012C", 	"JetHT-2012C", 	 	1, 1},	
	{"JetHT_Run2012D", 	"JetHT-2012D", 	 	1, 1},	
	{"JetHT_Run2012D_mis", 	"JetHT-2012D_mis", 	 	1, 1},	
};
