...
///////////////////////////////////////////////////////////////////////////////
void abcd1(){
	for( int iSample=0; iSample<(Category[2].SampleSize)/2; iSample++){   //FullPart
		cout<<"For "<<QCDMC[iSample].sample<<endl;
		///////////////////// Create New Tree and Forder //////////////////////==============================================================================
		//string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/mc/bg/"+QCDMC[iSample].name+".root";
		string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/Ntuple/bVeto/"+QCDMC[iSample].name+".root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/abcd/abcd_"+QCDMC[iSample].name+".root";
