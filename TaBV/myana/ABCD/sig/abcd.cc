...
void abcd(){
	for( int iSample=0; iSample<Category[1].SampleSize; iSample++){   //FullPart
		...
		//string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/mc/sig/"+SigMC[iSample].name+".root";
		string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/Ntuple/bVeto/"+SigMC[iSample].name+".root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/abcd/abcd_"+SigMC[iSample].name+".root";
		...
		for( int entry=0; entry<tree->GetEntries(); entry++ ){
			...
			if( numCA8NoTua_1>=1){ //constriant the evt 
