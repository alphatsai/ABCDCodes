...
///////////////////////////////////////////////////////////////////////////////
void abcd2(){
	for( int iSample=(Category[0].SampleSize)/2; iSample<Category[0].SampleSize; iSample++){   //FullPart
		cout<<"For "<<Data[iSample].sample<<endl;
		///////////////////// Create New Tree and Forder //////////////////////==============================================================================
		//string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/data/"+Data[iSample].name+".root";
		string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/Ntuple/bVeto/"+Data[iSample].name+".root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/abcd/abcd_"+Data[iSample].name+".root";
