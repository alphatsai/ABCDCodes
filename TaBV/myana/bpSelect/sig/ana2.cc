...
//void ana()
{
	...
	//for( int iSample=0; iSample<Category[0].SampleSize; iSample++){   //FullPart
		cout<<"For "<<SigMC[iSample].sample<<endl;
		///////////////////// Create New Tree and Forder //////////////////////==============================================================================
		string LoadPath	 = "/afs/cern.ch/user/j/jtsai/eos/cms/store/user/devdatta/NtuplesBprimeTobH_v1/"+SigMC[iSample].sample+"/*.root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/mc/sig/"+SigMC[iSample].name+".root";
		...
		/////////////////////// Save the root file ///////////////////////////===============================================================================
		newfile->Write();
		cout<<"Sample "<<SigMC[iSample].name<<" End !!!"<<endl<<endl;
	}// masspoint
}
