...
//#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/interface/format.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/interface/sampleInfo.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/interface/plotsInfoABCD.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/interface/setTDRStyle_2d.C"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/interface/histoInital.C"
using namespace std;
...
void abcd(){
	for( int iSample=0; iSample<Category[2].SampleSize; iSample++){   //FullPart
		...
		string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TuPb/result/root/mc/bg/"+TTMC[iSample].name+".root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/TaBV/result/root/abcd/abcd_"+TTMC[iSample].name+".root";
		...
		float weightSample=TTMC[iSample].xsec*lumi*1000/totalEvt;
...
//				if( numCA8NoTua_1!=0 && GenHiggsbb.size()==2 && GenHiggsOther.size()==0 ){ //no_bg
				if( numCA8NoTua_1!=0 ){ //no_signal
					...
					fillABCDcutRegion<float, float, float>(h1.GetTH1F("ABCD1.SubjetPt_Ht"),Ht,850,CA8JetInfo.tau2[CA8NoTua]/CA8JetInfo.tau1[CA8NoTua],0.55,weight);
