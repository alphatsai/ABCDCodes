...
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/setTDRStyle.C"
using namespace std;
...
void abcdCountPlots(){
	...
	string loadPath="/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/result/root/abcd";
	string savePath="/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/result/png/abcd";
	...
	h.push_back("ABCD2.HT1.CutRegion");
	h.push_back("ABCD2.HT2.CutRegion");
	h.push_back("ABCD2.HT3.CutRegion");
...
//	TH1F* hSum[h.size()][abcdFiles_Sum.size()];
	...
	for( int i=0; i<h.size(); i++){
		...
		for( int j=0; j<abcdFiles_Bg.size(); j++ ){
			...
			hBg[i][j]->GetYaxis()->SetRangeUser(0.1,10000);
