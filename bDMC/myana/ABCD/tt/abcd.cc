...
void abcd(){
	for( int iSample=0; iSample<Category[3].SampleSize; iSample++){   //FullPart
		...
		//string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/1106/result/root/mc/bg/"+TTMC[iSample].name+".root";
		string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/Ntuple/skim/"+TTMC[iSample].name+".root";
