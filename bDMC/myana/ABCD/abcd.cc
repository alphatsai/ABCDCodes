...
void abcd(){
	for( int iSample=0; iSample<Category[categoryNum].SampleSize; iSample++){   //FullPart
		...
		//string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/1106/result/root/mc/sample_/"+SampleChoise[iSample].name+".root";
		string LoadPath	 = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/Ntuple/skim/"+SampleChoise[iSample].name+".root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/result/root/abcd/abcd_"+SampleChoise[iSample].name+".root";
		...
		for( int entry=0; entry<tree->GetEntries(); entry++ ){
			...
			/*double weight=1;
			if( McFlag == 1 ){
				double weightSample = SampleChoise[iSample].xsec*lumi*1000/totalEvt;
