...
//#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/function.C"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/myformat.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/selection.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/TriggerBooking.h"
//#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/jetSelection.C"
//#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/mttCut.C"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/sampleInfo.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/plotsInfo.h"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/histoInital.C" //th1Initial, th2Initial
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/chainRoot.C"
#include "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/interface/reRegestJet.C"
...
void ana()
{
	...
	//for( int iSample=0; iSample<int(Category[categoryNum].SampleSize/2); iSample++){  //TopPart
	//for( int iSample=0; iSample<1; iSample++){  
	//for( int iSample=int(Category[categoryNum].SampleSize/2); iSample<Category[categoryNum].SampleSize; iSample++){ //BottomPart
	for( int iSample=0; iSample<Category[categoryNum].SampleSize; iSample++){   //FullPart
		...
		string LoadPath	 = "/afs/cern.ch/user/j/jtsai/eos/cms/store/user/devdatta/NtuplesBprimeTobH_v1/"+SampleChoise[iSample].sample+"/*.root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/result/root/mc/sample_/"+SampleChoise[iSample].name+".root";
		TChain* tree = new TChain("ntuple/tree");
		//chainRoot(tree, SampleChoise[iSample].sample, SampleChoise[iSample].numRootFiles);
		...
		/////////////////////// Save the root file ///////////////////////////===============================================================================
		newfile->Write();
		cout<<"Sample "<<SampleChoise[iSample].name<<" End !!!"<<endl<<endl;
	}// masspoint
}
