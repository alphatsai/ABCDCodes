...
//void ana()
{
	...
	//for( int iSample=0; iSample<int(Category[3].SampleSize/2); iSample++){  //TopPart
	//for( int iSample=0; iSample<1; iSample++){  
	for( int iSample=int(Category[3].SampleSize/2); iSample<Category[3].SampleSize; iSample++){ //BottomPart
	//for( int iSample=0; iSample<Category[3].SampleSize; iSample++){   //FullPart
		cout<<"For "<<BosMC[iSample].sample<<endl;
		///////////////////// Create New Tree and Forder //////////////////////==============================================================================
		string LoadPath	 = "/afs/cern.ch/user/j/jtsai/eos/cms/store/user/devdatta/NtuplesBprimeTobH_v1/"+BosMC[iSample].sample+"/*.root";
		string SavePath  = "/afs/cern.ch/work/j/jtsai/myAna/bpTobH/mywk/CMSSW_5_3_11/src/bDMC/result/root/mc/bg/"+BosMC[iSample].name+".root";
		TChain* tree = new TChain("ntuple/tree");
		//chainRoot(tree, BosMC[iSample].sample, BosMC[iSample].numRootFiles);
		...
		/////////////////////// Save the root file ///////////////////////////===============================================================================
		newfile->Write();
		cout<<"Sample "<<BosMC[iSample].name<<" End !!!"<<endl<<endl;
	}// masspoint
}
