...
const float ABCD1_yCut=0.244;
const float ABCD1_xCut=850;
const float ABCD2_yCut=0.244;
const float ABCD2_xCut=850;

const float Ht_Min=1000.;
const float Ht_Max=1.E6;
const float AK5JetPt_Min=50.;
//const float AK5JetPt_Min=100.;
const float AK5JetPt_Max=1.E6;
const float AK5JetAbsEta=2.4;
//const float CA8JetPt_Min=150.;
...
const float CA8JetPrunedMass_Min=75.;
//const float CA8JetPrunedMass_Min=50.;
const float CA8JetPrunedMass_Max=1.E6;
