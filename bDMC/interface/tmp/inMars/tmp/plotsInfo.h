...
struct TH1Info_ TH1Info[th1_size_] = {
	...
	{ 0,	"EvtInfo.dR.AK5CA8", 			"",	"dR(CA8,AK5)",   "Yields", 	"", 	50, 0, 5}, 	//06-06
	{ 1,	"EvtInfo.dR.AK5CA8.BpSelect",		"",	"dR(CA8,AK5)",   "Yields", 	"", 	50, 0, 5}, 	//06-06
...
struct TH2Info_ TH2Info[th2_size_]={
	...
	{ 0, "EvtInfo.dR-AK5CA8.BpMass",		"",	"b' Mass","dR(CA8,AK5)", 	"GeV/c^{2}", 	"", 	2000, 0, 2000, 50, 0, 5.0}, //08-29
	{ 1, "EvtInfo.dR-AK5CA8.BpMass.BpSelect",	"",	"b' Mass","dR(CA8,AK5)", 	"GeV/c^{2}", 	"", 	2000, 0, 2000, 50, 0, 5.0}, //08-29
	{ 0, "EvtInfo.dPhi-AK5CA8.BpMass",		"",	"b' Mass","dPhi(CA8,AK5)", 	"GeV/c^{2}", 	"", 	2000, 0, 2000, 35, 0, 3.5}, //08-29
	{ 1, "EvtInfo.dPhi-AK5CA8.BpMass.BpSelect",	"",	"b' Mass","dPhi(CA8,AK5)", 	"GeV/c^{2}", 	"", 	2000, 0, 2000, 35, 0, 3.5}, //08-29
};
...
struct Other2Info_ Other2Info[th2_size_] = {
	...
	{0, 2000, 0, 4.5, 0, -1111},	//EvtInfo_dR_AK5CA8_BpMass_ 	//08-29
	{0, 2000, 0, 4.5, 0, -1111},	//EvtInfo_dR_AK5CA8_BpMass_BpSelect_ 	//08-29
	{0, 2000, 0, 3.5, 0, -1111},	//EvtInfo_dPhi_AK5CA8_BpMass_ 	//08-29
	{0, 2000, 0, 3.5, 0, -1111},	//EvtInfo_dPhi_AK5CA8_BpMass_BpSelect_ 	//08-29
};
